        ...
        <section id="sem-cirurgia" className="bg-white  pb-20 px-4 text-gray-800">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left">
                    <h3 className="text-3xl md:text-4xl font-bold  text-[#2E3650]">Balão Gástrico:</h3>
                ...
                <div className="flex items-center justify-center">
                    <img src={IlustracaoBalao} alt="Ilustração do Balão Gástrico" className="rounded-lg w-3/4 max-w-lg" />
                </div>
            </div>
        </section>
    );
