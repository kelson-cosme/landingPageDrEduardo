        ...
        <section id="imc-calculator" className="bg-[#413E39] py-20 px-4 text-white">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-start">
                ...
                <div className="flex flex-col gap-6">
                    <h2 className="text-3xl font-bold leading-tight">DESCUBRA SE O BALÃO GÁSTRICO É IDEAL PARA VOCÊ EMAGRECER COM SEGURANÇA, SEM CIRURGIA.</h2>
                   ...
                   <CtaButton className="mt-6 self-start">
                        AGENDAR MINHA AVALIAÇÃO
                    </CtaButton>
                </div>

                {/* Coluna da Tabela */}
                <div className=" lg:p-8 rounded-lg lg:border-1">
