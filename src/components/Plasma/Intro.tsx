        ...
        <section id="o-que-e" className="bg-[#F9FAFF] py-20 px-4 text-gray-800">
            <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-left" data-aos="fade-up">
                    ...
                    <p className="text-gray-600 mb-3">
                    Durante o procedimento, o Plasma de Argônio cauterizará a região da anastomose (união entre estômago e intestino), para estimular cicatrização e reduzir o seu diâmetro.</p>
                    <p className="text-gray-600 mb-3">
